        ...
        <>
            <form onSubmit={(e) => !editando ? guardarProducto(e) : confirmarEdicion(e)} className="contenedorFormPrdocutos" action="">
                ...
                <div className="itemForm">
                    ...
                    <input value={values.precio} onChange={(e) => handleInputChange(e)} className="item-input" type="number" min={0} name="precio" id="precio" />
                </div>
                <div className="itemForm">
                    <label className="item-label" htmlFor="stcok">Stock</label>
                    <input value={values.stock} onChange={(e) => handleInputChange(e)} className="item-input" type="number" min={0} name="stock" id="stock" />
                </div>
                <div className="itemForm">
